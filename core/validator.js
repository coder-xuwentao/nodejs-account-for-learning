...
class LinValidator {
  ...
  async _check(key, alias = {}) {
    ...
    if (isCustomFunc) {
      ...
      // RuleField {
      //   rules: [
      //     Rule { name: 'isLength', msg: '密码至少6个字符，最多22个字符', params: [Array] },
      //     Rule {
      //       name: 'matches',
      //       msg: '密码长度必须在6~22位之间，包含字符、数字和 _ ',
      //       params: [Array]
      //     }
      //   ]
      // }
      ...
      // 得到body、query的属性“key”对应的值
      const param = this._findParam(key)
      // console.log(param);
      /*
      { value: '123456@qq.com', path: [ 'body', 'email' ] }
      */
